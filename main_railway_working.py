    ...
    try:
        ...
        try:
            ...
            if supabase_url and supabase_key:
                ...
                print("WARNING: Supabase environment variables not found, using local databases")
            ...
            await user_settings.create_all_user_settings_tables()
            await managers_handler.create_all_managers_tables()
