"""
Render-optimized main.py
This version uses simplified PDF compression to avoid system dependency issues
"""
...
# Use simplified PDF compressor for Render deployment
